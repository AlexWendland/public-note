...
In figure 2 you see how they have separated up the data that is needed for the [PCB](../../notes/process_control_block_(pcb).md) into small subblocks. The components within the LWP are swappable for different user level threads, meaning when a context switch is required in the LWP there is less overhead in that.
...
- the [PCB](../../notes/process_control_block_(pcb).md) for storing user-level registers,
