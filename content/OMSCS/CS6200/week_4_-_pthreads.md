...
[POSIX](../../notes/portable_operating_system_interface_(posix).md)

[PThreads](../../notes/posix_threads_(pthreads).md)

# Thread interface

The core [data structure](../../notes/data_structure.md) in the [PThreads](../../notes/posix_threads_(pthreads).md) library is `pthread_t` which represents a thread. This can be created through:
``` c
int pthread_create(
	pthread_t *thread,
...
The [PThreads](../../notes/posix_threads_(pthreads).md) library allows you to create and use [mutexes](../../notes/mutex.md).
...
[Mutex](../../notes/mutex.md) have 3 attributes:
- Mutex Type: can be changed to allow for [deadlock](../../notes/deadlock.md) detection.
...
- Globally order locks to prevent [deadlock](../../notes/deadlock.md).
- Always unlock the correct mutex.

# [Conditional variables](../../notes/conditional_variables_(mutex).md)

[PThreads](../../notes/posix_threads_(pthreads).md) supports the [API](../../notes/application_programming_interface_(api).md) we saw in the last lecture.
...
Some notes on [conditional variables](../../notes/conditional_variables_(mutex).md):
...
- To avoid [spurious wakeups](../../notes/spurious_wakeups.md) think about if you need to hold the [mutex](../../notes/mutex.md) when doing your signal or broadcast.
