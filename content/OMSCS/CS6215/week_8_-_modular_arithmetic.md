...
First lets remind ourselves of the definition of [modular arithmetic](../../notes/modular_arithmetic.md).

[Modular arithmetic](../../notes/modular_arithmetic.md)

Within a computers architecture as numbers are stored in [binary](../../notes/binary.md) calculating mod $2^k$ is simple as taking the $k$ least significant bits. Therefore it is quite cheap. However, when the value is not $2^k$ it can get harder.

# Exponent problem

[Statement](../../notes/modular_exponent_problem.md#statement)
...
[Modular exponent algorithm](../../notes/modular_exponent_algorithm.md)
...
[Modular multiplicative inverse existence](../../notes/modular_multiplicative_inverse_existence.md)

Though knowing an inverse exists isn't helpful algorithmically.

[Statement](../../notes/modular_inverse_problem.md#statement)

Let's first look at a helpful rule for finding this.

[Euclid's rule](../../notes/euclid's_rule.md)

We can use this rule to calculate [greatest common divisors](../../notes/greatest_common_divisor.md).

[Euclidean algorithm](../../notes/euclidean_algorithm.md)

Moreover we can extend this to calculate the inverse.

[Extended Euclidean algorithm](../../notes/extended_euclidean_algorithm.md)

# Example

To compute $7^{-1}$ mod $360$  we run the [Extended Euclidean algorithm](../../notes/extended_euclidean_algorithm.md) on $7$ and $360$.
