...
| [DFS to find connected components in an undirected graph](../../notes/dfs_to_find_connected_components_in_an_undirected_graph.md) | [Find connected components in a undirected graph](../../notes/find_connected_components_in_an_undirected_graph.md)                 | $O(\vert V \vert + \vert E \vert)$                       |                                                                     |
