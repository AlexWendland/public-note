...
[Dynamic programming](../../notes/dynamic_programming.md) is a method to speed up [recursion](../../notes/recursion.md) especially when the recursive algorithm computes the same step multiple times.
...
>```
>
>This was done [iteratively](../../notes/iterative_algorithms.md) so the [run time](../../notes/run_time_complexity.md) is easy to compute. The set up step takes $O(1)$ time, then the loop takes $(n-2)O(1) = O(n)$ time giving the run time to be $O(1) + O(n) = O(n)$.
...
The benefits to [Dynamic programming](../../notes/dynamic_programming.md) over [Memoization](../../notes/memoization.md) are:
...
# [Dynamic Programming](../../notes/dynamic_programming.md) approach

## Step 1: define subproblem in words

For [Fibonacci numbers](../../notes/fibonacci_sequence.md) this was simply to calculate $Fib(n)$.
...
For [Fibonacci numbers](../../notes/fibonacci_sequence.md) this was $Fib(n) = Fib(n-1) + Fib(n-2)$.
...
Given two [sequences](../../notes/sequence.md) $X =\{x_i\}_{i=1}^n$ and $Y = \{y_i\}_{i=1}^n$ the goals is to find the length of the longest [sequence](../../notes/sequence.md) which is a [subsequence](../../notes/subsequence.md) of both $X$ and $Y$.
...
The [runtime](../../notes/run_time_complexity.md) of my algorithm can be broken down into 2 main steps. (For this I assume the [sequences](../../notes/sequence.md) are of the same length $n$). Setting up the matrix which is $n^2$ operations and running the main for loop which has $n^2$ steps and uses $O(1)$ operations in each step. Giving the [run time](../../notes/run_time_complexity.md) to be $O(n^2) + O(n^2) = O(n^2)$.
...
To approach [Dynamic programming](../../notes/dynamic_programming.md) problems follow these steps
