...
week: 1
---
# Week 1 - [Knapsack Problem](../../notes/knapsack_problem.md)

[Statement](../../notes/knapsack_problem.md#statement)
...
To define the [recursion](../../notes/recursion.md) for this problem first set the base case $K(0,b) = K(i,0) = 0$. More generically define,
...
The Knapsack is [Nondeterministic Polynomial time (NP)](../../notes/nondeterministic_polynomial_time_(np).md), meaning there is no polynomial algorithm for the knapsack problem.
...
To define the [recursion](../../notes/recursion.md) for this problem we set
