...
[Connection between OSI and IPS models](../../notes/connection_between_osi_and_ips_models.md)
• What are sockets?
...
[End to end principle](../../notes/end_to_end_principle.md)
...
The first version of this structure was the [OSI model](../../notes/open_systems_interconnection_(osi)_model.md) - though later refinements came about such as [IPS model](../../notes/internet_protocol_stack_(ips)_5_layers.md) which combined some layers.

[OSI model](../../notes/open_systems_interconnection_(osi)_model.md)
...
This is responsible for converting data from its encoded format to one understood by the application. This might be as simple as converting [bits](../../notes/bit.md) to [ASCII](../../notes/american_standard_code_for_information_interchange_(ascii).md).

[Session layer](../../notes/layer_5_session.md)
...
[Transport layer](../../notes/layer_4_transport.md)

This is responsible for getting the data correctly from one end to another. It uses protocols such as [UDP](../../notes/user_datagram_protocol_(udp).md) and [TCP](../../notes/transmission_control_protocol_(tcp).md). This attaches source and destination [ports](../../notes/port.md) to the message to make it a [segment](../../notes/segment.md).

Note that [TCP](../../notes/transmission_control_protocol_(tcp).md) adds
- multiplexing,
...
[Network layer](../../notes/layer_3_network.md)

The network layer is responsible for getting the data to the correct host in the internet. It wraps the [Segment](../../notes/segment.md) up with the [IP addresses](../../notes/internet_protocol_(ipv4).md) to make a [datagram](../../notes/packets.md). This uses the [IP](../../notes/internet_protocol_(ip).md) to do this.

[Data Link layer](../../notes/layer_2_data_link.md)

This layer uses [MAC addresses](../../notes/mac_address.md) and bind this to the [datagram](../../notes/packets.md) to make a [frame](../../notes/frame_(networks).md). This is used to safely pass [segment](../../notes/segment.md) through [networks](../../notes/network.md).

[Physical layer](../../notes/layer_1_physical.md)

This facilitates communicate these [frames](../../notes/frame_(networks).md) through the physical hardware associated to the network be that cables or wifi.

[Encapsulation](../../notes/encapsulation.md)

The end hosts have to implement encapsulation and de-encapsulation however intermediary don't need to. This is summarised by the [End to end principle](../../notes/end_to_end_principle.md).
...
[Network Address Translation (NAT)](../../notes/network_address_translation_(nat).md)

Most home [routers](../../notes/router.md) have a [NAT](../../notes/network_address_translation_(nat).md) in them this means your home internet will have a single [Internet Protocol (IPv4)](../../notes/internet_protocol_(ipv4).md) to the outside world.

[Firewall](../../notes/firewall.md)

# Shape of the internet

[Internet protocol stack hourglass shape](../../notes/internet_protocol_stack_hourglass_shape.md)

There is a model that was purposed to explain this shape.

[Evolutionary Architecture model (EvoArch)](../../notes/evolutionary_architecture_model_(evoarch).md)

In some set ups of this model the width of the layers tend to follow that of the internet with a similar hourglass shape. Implying there might not be anything particularly special about [Internet Protocol (IP)](../../notes/internet_protocol_(ip).md), [UDP](../../notes/user_datagram_protocol_(udp).md), or [TCP](../../notes/transmission_control_protocol_(tcp).md) but more there was always going to be a bottle neck here.

These [protocols](../../notes/protocol_(networks).md) do defend one another for a replacement to [IP](../../notes/internet_protocol_(ip).md) to come about it would have to rival being used by both [TCP](../../notes/transmission_control_protocol_(tcp).md) and [UDP](../../notes/user_datagram_protocol_(udp).md).
...
[layer 1](../../notes/layer_1_physical.md)

[Repeater](../../notes/repeater.md)

[Hub](../../notes/hub.md)

[layer 2](../../notes/layer_2_data_link.md)

[Bridge](../../notes/bridge.md)

[Switch](../../notes/switch.md)

[layer 3](../../notes/layer_3_network.md)

[Router](../../notes/router.md)

# Spanning tree algorithm

There is a problem with [Switching](../../notes/switching.md) when there are multiple [switches](../../notes/switch.md) that form loops. A message may go round infinitely. To get around this the switches in a [network](../../notes/network.md) try to form a spanning tree amongst themselves so they stop infinite cycles.

[Spanning Tree Protocol (STP)](../../notes/spanning_tree_protocol_(stp).md)
