...
[Host (networks)](../../notes/host_(networks).md)

[Client](../../notes/client.md)
...
[Internet Protocol (IPv4)](../../notes/internet_protocol_(ipv4).md)

[Subnets](../../notes/subnets.md)
...
[Gateway](../../notes/gateway.md)

[Routers](../../notes/router.md) make the hierarchy on the internet possible by owning the prefix for that [subnet](../../notes/subnets.md).

Whilst these devices are called [routers](../../notes/router.md) and [switches](../../notes/switch.md) there is a more abstract concept here.

- [Switching](../../notes/switching.md): The process of moving data within networks.
- [Routing](../../notes/routing.md): The process of moving data between networks.
...
[Layer 1 Physical](../../notes/layer_1_physical.md)

[Layer 2 Data Link](../../notes/layer_2_data_link.md)

[MAC address](../../notes/mac_address.md)

[Layer 3 Network](../../notes/layer_3_network.md)
...
[Layer 6 Presentation](../../notes/layer_6_presentation.md)

[Layer 7 Application](../../notes/layer_7_application.md)

The main other model of the internet is [IPS model](../../notes/internet_protocol_stack_(ips)_5_layers.md)

[IPS model](../../notes/internet_protocol_stack_(ips)_5_layers.md)
...
- [MAC address](../../notes/mac_address.md),
- [Internet Protocol (IPv4)](../../notes/internet_protocol_(ipv4).md), and
- [Network mask](../../notes/network_mask.md) (this tells the [host](../../notes/host_(networks).md) which other [hosts](../../notes/host_(networks).md) are on its [network](../../notes/network.md)).
...
Every host has an [ARP cache](../../notes/arp_cache.md) that stores the [MAC address](../../notes/mac_address.md) against each [Internet Protocol (IPv4)](../../notes/internet_protocol_(ipv4).md) it knows in the [network](../../notes/network.md). If host B's address is already in host A's [ARP cache](../../notes/arp_cache.md) it can use that to generate the layer 2 and 3 headers.

If not it will need to make an [ARP](../../notes/address_resolution_protocol_(arp).md) request to the [network](../../notes/network.md). It broadcasts its IP and MAC address on the network asking for the host at host B's IP address to respond. It does this by setting in the layer 2 header the all f's MAC address - an address reserved for the purpose of broadcasting to the local network.
...
These are the rules for [Switching](../../notes/switching.md) so applies to anything that can do switching.
...
[Virtual Local Area Networks (VLAN)](../../notes/virtual_local_area_networks_(vlan).md)
...
[Node (IPv6)](../../notes/node_(ipv6).md)

[Router (IPv6)](../../notes/router_(ipv6).md)
...
the first entry would say any IP address matching the first 24 bits or the first 3 decimals of the IP address go here whereas the second entry says any address matching the first 16 bits or 2 decimals then go here. The second entry is called [route summarization](../../notes/route_summarization.md). It is actually referring to a lot of [subnets](../../notes/subnets.md) but groups them all index one entry as the first step is always to go to a single router. This can only be done if you arrange your IP addresses in a hierarchical manner.
...
Some were already described above. Such as [ARP](../../notes/address_resolution_protocol_(arp).md) (RFC 826).

[FTP](../../notes/file_transfer_protocol_(ftp).md)
...
[Transport Layer Security (TLS)](../../notes/transport_layer_security_(tls).md)

[Domain Name System (DNS)](../../notes/domain_name_system_(dns).md)

[Dynamic Host Configuration Protocol (DHCP)](../../notes/dynamic_host_configuration_protocol_(dhcp).md)
...
[Autonomous system (AS)](../../notes/autonomous_system_(as).md)
...
[Client-Server model](../../notes/client-server_model.md)

[Peer-peer model](../../notes/peer-peer_model.md)
...
[Transmission Control Protocol (TCP)](../../notes/transmission_control_protocol_(tcp).md)

[User Datagram Protocol (UDP)](../../notes/user_datagram_protocol_(udp).md)
