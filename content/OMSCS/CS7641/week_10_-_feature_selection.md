...
This problem is know to be [NP-hard](../../notes/np-hard.md).

# Techniques

There are 2 main families of techniques to solve this problem
- [Filtering](../../notes/filtering_(feature_selection).md), a process of deciding which features to keep before passing it to the learning algorithm, and
- [Wrapping](../../notes/wrapping_(feature_selection).md), using the learning algorithm to decide which features to keep.

[Filtering](../../notes/filtering_(feature_selection).md) has the following pay offs
...
[Wrapping](../../notes/wrapping_(feature_selection).md) has the following pay offs
...
- [Decision tree](../../notes/decision_tree.md) does feature selection already, and
- [Neural network](../../notes/neural_network.md) internally does features selection.
...
[Strongly relevant feature](../../notes/strongly_relevant_feature.md)

[Weakly relevant feature](../../notes/weakly_relevant_feature.md)

[Irrelevant feature](../../notes/irrelevant_feature.md)
...
[Useful feature](../../notes/useful_feature.md)
