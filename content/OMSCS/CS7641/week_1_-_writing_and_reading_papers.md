...
Whilst models have their [bias](../../notes/bias_(modelling).md) so do do humans and the author may have missed something. We all come with [confirmation bias](../../notes/confirmation_bias.md) of our own hypothesises.
...
## Rule 1: [Single Responsibility Principle (SRP)](../../notes/single_responsibility_principle_(srp).md)
...
By adding more conclusions to a paper, you decrease its over all perceived value. Similar to the [broken tea cup analogy](../../notes/broken_tea_cup.md).

## Rule 2: Write for a laymen

You are the world leading expert on what you are trying to get across. You will assume people know more than they do, so assume you are writing the paper for someone who knows nothing about your area. Also, don't help the pervasive [Imposters syndrome](../../notes/imposters_syndrome.md) by assuming people know stuff they don't.

It is also helpful to understand human [Psychology](psychology.md) so we can write them in a human friendly way and get our point across better. For example [start and end point bias](../../notes/start_and_end_point_bias.md) means we should focus the most time on opening and closing sections.

# Rule 3: Stick to the [Context content conclusion (CCC)](../../notes/context_content_conclusion_(ccc).md) model
...
[Context content conclusion (CCC)](../../notes/context_content_conclusion_(ccc).md)
...
## Rule 4: Organise you logical flow by using [Separation of concerns (SoC)](../../notes/separation_of_concerns_(soc).md) and using parallelism

Avoid dipping in an out of a concept constantly revisiting them unless they are the central purpose to your paper. Use the [separation of concerns](../../notes/separation_of_concerns_(soc).md) principle to isolate individual ideas to area.
