...
- [training data](../../notes/training_data.md) to build $\hat{V}$ of the form $T \subset A \times B$,
- a method to evaluate this approximation - the [objective function](../../notes/objective_function.md), and
...
The evaluation process for a linear function is commonly something like [Mean squared error (MSE)](../../notes/mean_squared_error_(mse).md). Evaluating the output of the [prediction](../../notes/prediction.md) $\hat{V}$ against the training data $T$.
