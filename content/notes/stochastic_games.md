...
>- A set of actions $A_i$ for each player (which may depend on the state $A_i(s) \subset A_i$); we refer to the joint set of actions as $A = A_1 \times A_2 \times \ldots \times A_n$,
