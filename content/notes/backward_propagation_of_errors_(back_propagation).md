...
This is the specific implementation of [gradient decent](gradient_descent.md) applied to [neural networks](neural_network.md). There are two stages of this calculation:
