...
>4. **Synchronization**: Methods in which two processes can [synchronize](synchronization.md) so as not to adversely affect one another's operation. Examples are [mutexes](mutex.md) or [semaphores](semaphores.md).
