...
type: definition
---
> [!note] Inverted page tables
> Traditional [page tables](page_tables.md) are indexed by [virtual addresses](virtual_memory.md), but on 64-bit architectures, the virtual address space can be many petabytes, while physical memory is usually much smaller (gigabytes or terabytes). This results in large [page tables](page_tables.md), consuming significant memory.
>
