...
>
>The network will try to intelligently replicate memory locations to reduce memory latency for the machine. However this will require consistency protocols to ensure any replicated state is consistent between machines.
