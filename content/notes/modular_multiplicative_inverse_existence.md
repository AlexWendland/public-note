...
tags:
  - maths
title: Modular multiplicative inverse existence
type: lemma
---
# Statement
...
Let the [greatest common divisor](greatest_common_divisor.md) be $gcd(x, N) = y$, so $y \cdot \overline{x} = x$ and $y \cdot \overline{N} = N$ where $0 < \overline{N} \leq N$. Therefore consider the following [modular arithmetic](modular_arithmetic.md)
