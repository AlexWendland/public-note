...
In [Python Index](python_index.md), lists, sets and dictionaries are *mutable* whereas numbers, strings, tuples and frozen sets are *immutable*.
...
though read more about this in [Mutability in Python](mutability_in_python.md).
