...
>Two sets of points $X_1, X_2 \subset \mathbb{R}^n$ are *linearly separable* if there is some [hyperplane](hyperplane.md) $P$ defined $w_i, \theta \in \mathbb{R}$ for $1 \leq i \leq n$:
