...
title: Wrap 3rd party libraries
tags:
  - programming
  - clean-code
type: practice
...
It is generally good practice to wrap 3rd party libraries with your own [API](api.md) to be used within your code bases. However, this does come with some downsides. There is a [balance between library providers and users](balance_between_library_providers_and_users.md) and depending on how well they have managed this balance also effects the decision on whether to wrap the library or not.
...
5. **[Premature Abstraction](premature_abstraction.md)**: For very small projects or prototypes, wrapping might be overkill and could unnecessarily complicate the codebase.
