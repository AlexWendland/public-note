...
> \end{array} \right ) .
> $$
>Such matrices will be referred to as $M_{n \times m}(\mathbb{F})$. They come with canonical operations such as [matrix addition](matrix_addition.md) and [matrix multiplication](matrix_multiplication.md) (when $n = m$).
