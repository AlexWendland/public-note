...
The idea will be to make every element in our [training data](training_data.md) $T$ its own cluster. Then we take the union of two clusters which are considered the closest. For this linkage clustering we use the minimum distance of points in the cluster. i.e.
$$
