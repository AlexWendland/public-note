...
>The ones complement of a [binary](binary.md) number is obtained by flipping 1's and 0's. Therefore if you were to add a number with its one complement you would end up with a number of all 1's.
>
