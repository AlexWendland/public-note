...
>1. **Announcement**: The victim [AS](autonomous_system_(as).md) under attack announces the targeted destination [IP](internet_protocol_(ip).md) or prefix to its upstream provider or Internet Exchange Point (IXP).
