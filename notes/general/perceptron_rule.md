...
This will only stop if $T$ is [linearly separable](linearly_separable.md). Moreover, [The perceptron rule using binary step converges in finite time if the dataset is linearly separable](the_perceptron_rule_using_binary_step_converges_in_finite_time_if_the_dataset_is_linearly_separable.md).
