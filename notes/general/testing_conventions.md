...
I am a proponent of [test driven development](test_driven_development_(tdd).md), where you implement a very simple loop.

Write a minimal test that fails > write some production code > check test passes

Though you can read more about this in the [Test Driven Development (TDD)](test_driven_development_(tdd).md) note.
