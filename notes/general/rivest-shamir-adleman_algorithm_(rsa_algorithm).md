...
name: Rivest-Shamir-Adleman algorithm (RSA algorithm)
tags:
  - programming
type: algorithm
---
...
Note this works from [Euler's theorem (modular arithmetic)](euler's_theorem_(modular_arithmetic).md) as $ed = 1 + k(p-1)(q-1)$ so
...
4. Can't send the same $m$ and $e$ out multiple times.
	1. If you have 3 public keys $(N_1, 3)$, $(N_2, 3)$ and $(N_3,3)$ then using the [Chinese remainder theorem](chinese_remainder_theorem.md) you can recover the original message $m$.
