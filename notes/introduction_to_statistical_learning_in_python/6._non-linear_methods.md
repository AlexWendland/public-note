...
- [polynomial regression](../general/polynomial_regression.md):  Use polynomial features,
- Step functions: Cut region up and take mean,
- Regression splines: Cut region up and fit polynomials with smooth intersections,
	- What is the difference between this and [Boosting](../general/boosting.md)?
- Smoothing splines: Similar to regression,
- Local regression: Similar to splines but with overlapping boundaries,
- [Generalised Additive Models (GAM)](../general/generalised_additive_models_(gam).md): Combining all the above,
...
[Step function methods](../general/step_function_methods.md)

One of the simplest methods in [step function methods](../general/step_function_methods.md) is to choose meaningful intervals in your [domain](../general/function_domain.md). Then setting $\hat{f}(x)$ to be the mean of [test data](../general/testing_data.md) in this region. This is likely not applied much we are using this as an idea to be used with other methods.
...
## [GAM](../general/generalised_additive_models_(gam).md)
