...
$$
Which derives us the [Bellman equation](../../general/bellman_equation.md) again.
$$
...
$$
after seeing these samples we can calculate the [Return (RL)](../../general/return_(rl).md) for each step within the trajectory and use it estimate the [value function](../../general/value_function_(rl).md) and [quality function](../../general/quality_function_(rl).md) above.
$$
\begin{align*}
...
\end{align*}
$$
To solve this beings us back to [Bellman equation](../../general/bellman_equation.md)'s above.
$$
\begin{align*}
...
[Value iteration (MDP)](../../general/value_iteration_(mdp).md)
