...
name: Week 1 - Supplementary Introduction to Reinforcement Learning
tags:
  - OMSCS
type: lecture
week: 1
...
Later in the course we will be adding deep learning into our use of [reinforcement learning](../../general/reinforcement_learning.md). This is mainly using large [neural networks](../../general/neural_network.md) to assist with the learning process.
