...
[VC dimension](../../general/vapnik-chervonenkis_dimension.md)
...
$$
For a finite hypothesis space $H$ for $VC(H) = d$ we require $\vert H \vert \geq 2^d$ as we need at last that many hypothesis to split the cases up. Therefore we get a natural upper bound on the [VC dimension](../../general/vapnik-chervonenkis_dimension.md)
$$
