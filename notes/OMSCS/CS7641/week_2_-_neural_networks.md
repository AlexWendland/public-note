...
[Perceptron (neural network)](../../general/perceptron_(neural_network).md)

Where we define an [activation function](../../general/activation_function.md) as.

[Activation function](../../general/activation_function.md)

First we will just take the function to be [Binary step](../../general/binary_step.md) which introduces an extra parameter $\theta$.
...
Let our [training data](../../general/training_data.md) $(x,y) \in T$ have $x = (x_1, x_2, \ldots, x_n) \in \mathbb{R}^n$ and $w = (w_1, w_2, \ldots w_n)$ be our weights for a [perceptron](../../general/perceptron_(neural_network).md) as before. The define the following [error function](../../general/error_function_(modelling).md)
$$
...
Where this function looks similar to the [binary step](../../general/binary_step.md) function with one big advantage, that it is [differentiable](../../general/differentiation.md).
...
If we use the [Sigmoid function](../../general/sigmoid_function.md) for each of the [perceptrons](../../general/perceptron_(neural_network).md) [activation function](../../general/activation_function.md) or some other [differentiable](../../general/differentiation.md) [activation function](../../general/activation_function.md) - the function this neural network represents is also [differentiable](../../general/differentiation.md). In this case we can run [gradient decent](../../general/gradient_decent.md) which in this case is called [Backward propagation of errors (Back propagation)](../../general/backward_propagation_of_errors_(back_propagation).md).
...
Complexity in a [neural network](../../general/neural_network.md) is defined by:
...
- Single [perceptron](../../general/perceptron_(neural_network).md) with [binary step](../../general/binary_step.md) [activation function](../../general/activation_function.md): Can only represent half spaces,
- Multi [perceptron](../../general/perceptron_(neural_network).md) with [binary step](../../general/binary_step.md) [activation function](../../general/activation_function.md): Can represent any [Boolean function](../../general/boolean_function.md).
- Multi [perceptron](../../general/perceptron_(neural_network).md) with [Sigmoid](../../general/sigmoid_function.md) [activation function](../../general/activation_function.md) with one hidden layer: Can represent any [continuous function](../../general/continuous_function.md).
- Multi [perceptron](../../general/perceptron_(neural_network).md) with [Sigmoid](../../general/sigmoid_function.md) [activation function](../../general/activation_function.md) with two hidden layers: Can represent any function.

Whilst this appears like a multi [perceptron](../../general/perceptron_(neural_network).md) with [Sigmoid](../../general/sigmoid_function.md) [activation function](../../general/activation_function.md) with two hidden layers has no restriction bias - once you have picked your hyper parameters, i.e. the number of layers and nodes, then you have restricted the number of functions you can represent.
...
- Training [neural networks](../../general/neural_network.md) normally have a preference for low complexity networks over high complexity ones.
	- [Occam's razor](../../general/occam's_razor.md)
