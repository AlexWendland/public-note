...
name: Week 1 - Knapsack Problem
tags:
  - OMSCS
type: lecture
week: 1
---
# Week 1 - [Knapsack Problem](../../general/knapsack_problem.md)

[Statement](../../general/knapsack_problem.md#statement)
...
Lets define a [dynamic program](dynamic_programming.md) for the single copy Knapsack problem.
...
To define the [recursion](../../general/recursion.md) for this problem first set the base case $K(0,b) = K(i,0) = 0$. More generically define,
...
The Knapsack is [Nondeterministic Polynomial time (NP)](../../general/nondeterministic_polynomial_time_(np).md), meaning there is no polynomial algorithm for the knapsack problem.
...
To define the [recursion](../../general/recursion.md) for this problem we set
...
The run time of the algorithm is still $O(nb)$ but it's [spacial complexity](../../general/spacial_complexity.md) has reduced.
