...
name: Week 8 - Modular Arithmetic
tags:
  - OMSCS
type: lecture
week: 8
...
[Modular arithmetic](../../general/modular_arithmetic.md)
...
[Modular multiplicative inverse existence](../../general/modular_multiplicative_inverse_existence.md)

Though knowing an inverse exists isn't helpful algorithmically.

[Statement](../../general/modular_inverse_problem.md#statement)

Let's first look at a helpful rule for finding this.

[Euclid's rule](../../general/euclid's_rule.md)

We can use this rule to calculate [greatest common divisors](../../general/greatest_common_divisor.md).

[Euclidean algorithm](../../general/euclidean_algorithm.md)
