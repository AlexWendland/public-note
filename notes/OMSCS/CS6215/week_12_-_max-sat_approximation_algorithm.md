...
name: Week 12 - Max-SAT approximation algorithm
tags:
  - OMSCS
type: lecture
week: 12
...
[Max-SAT](../../general/max-satisfiability_problem.md#statement)

This is [NP-hard](../../general/np-hard.md).

[Max-SAT is NP-hard](../../general/max-sat_is_np-hard.md)
...
[Pseudocode](../../general/max-sat_random_approximation_algorithm.md#pseudocode)

A version of this algorithm works even better on the following problem.

[Statement](../../general/max-k-exact-satisfiability_problem.md#statement)
...
We can use [Max-SAT](../../general/max-satisfiability_problem.md) to show this version of [linear programming](../../general/linear_programme.md) is [NP-hard](../../general/np-hard.md).

[Integer linear programming is NP-hard](../../general/integer_linear_programming_is_np-hard.md)
...
\end{align*}
$$
where this last step comes from the [Taylor expansion](../../general/taylor_expansion.md) for $e^{-x}$
$$
...
- Reduce it to [ILP](../../general/integer_linear_programming_problem.md),
- Relax to [linear programming](../../general/linear_programme.md) and solve, and
