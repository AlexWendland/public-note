...
name: Week 6 - Graph algorithms - strongly connected components
tags:
  - OMSCS
type: lecture
week: '6'
...
- [Tree edges](../../general/dfs_tree_(algorithm).md)
	- First explored edges (black) that form a [spanning](../../general/spanning_subgraph.md) [subgraph](../../general/subgraph.md).
	- Examples: $B \rightarrow A$, $A \rightarrow D$
	- $post(z) > post(w)$
- [Back edges](../../general/dfs_tree_(algorithm).md)
	...
	- $post(z) < post(w)$
- [Forward edges](../../general/dfs_tree_(algorithm).md)
	- Edges that go further down the tree.
	- Examples: $B \rightarrow E$, $D \rightarrow G$
	- $post(z) > post(w)$
- [Cross edges](../../general/dfs_tree_(algorithm).md)
...
Given a linear ordering we know the minimal vertex is a source and the maximal vertex is a sink. This gives us another algorithm to find a [topologically sorting](../../general/topological_sorting_(dag).md):
...
[strongly connected](../../general/strongly_connected_(directed_graphs).md)

[strongly connected components](../../general/strongly_connected_components_(directed_graphs).md)

Then we can define the [strongly connected component graph](../../general/strongly_connected_component_graph_(directed_graph).md)

[strongly connected component graph](../../general/strongly_connected_component_graph_(directed_graph).md)
...
- Find a sink [strongly connected component](../../general/strongly_connected_components_(directed_graphs).md),
- Remove it,
- Repeat!

We use sinks as if we start a [DFS](../../general/depth-first_search_(dfs).md) algorithm in a sink [strongly connected component](../../general/strongly_connected_components_(directed_graphs).md) we only discover vertices in that [strongly connected component](../../general/strongly_connected_components_(directed_graphs).md).
...
We would hope for the analogous statements in a general [directed graph](../../general/directed_graph.md):
- The vertex with the lowest post order number is in a sink [strongly connected component](../../general/strongly_connected_components_(directed_graphs).md)
- The vertex with the highest post order number is in a source [strongly connected component](../../general/strongly_connected_components_(directed_graphs).md)
...
[A vertex with the highest post order number lies in a source SCC](../../general/a_vertex_with_the_highest_post_order_number_lies_in_a_source_scc.md)

Suppose we a directed graph $G$ define the [reverse directed graph](../../general/reverse_directed_graph.md) $G^R$. Now observe

[The strongly connected components are the same in a directed graph and its reverse](../../general/the_strongly_connected_components_are_the_same_in_a_directed_graph_and_its_reverse.md)

Moverover we have.

[Taking the reverse respects going to the strongly connected component graph](../../general/taking_the_reverse_respects_going_to_the_strongly_connected_component_graph.md)
