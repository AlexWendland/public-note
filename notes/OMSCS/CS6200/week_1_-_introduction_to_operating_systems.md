...
name: Week 1 - Introduction to Operating systems
tags:
  - OMSCS
type: lecture
week: 1
...
In comparison an [OS](../../general/operating_system_(os).md) does the following:
...
- Optimise for common case
	- Where will the [OS](os.md) be used?
...
[Trap instruction](../../general/trap_instruction.md)
...
[OS](../../general/operating_system_(os).md) such as LINUX instead have gone for a modular approach, where [OS](../../general/operating_system_(os).md) applications have to conform to a standard interface for system calls. The user then can add the modules to the [OS](../../general/operating_system_(os).md) that they want to use. This had the following advantages:
- Easier to maintain as it is less code,
- Smaller footprint in memory,
- Less resources used to run the [OS](../../general/operating_system_(os).md),
...
- It is easy to verify behaviour, so you can be sure the [OS](../../general/operating_system_(os).md) behaves well.
