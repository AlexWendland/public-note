...
tags:
  - OMSCS
title: Week 5 - Beyond Multiprocessing ... Multithreading and the SunOS Kernel
type: lecture
week: 5
---
...
![Sunos Fig 1](../../../static/images/SunOS_fig_1.png)
...
In figure 2 you see how they have separated up the data that is needed for the [PCB](../../general/process_control_block_(pcb).md) into small subblocks. The components within the LWP are swappable for different user level threads, meaning when a context switch is required in the LWP there is less overhead in that.
...
- the [PCB](../../general/process_control_block_(pcb).md) for storing user-level registers,
