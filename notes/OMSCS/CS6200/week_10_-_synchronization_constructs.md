...
name: Week 10 - Synchronization Constructs
tags:
  - OMSCS
type: lecture
week: 10
...
Previously we discussed [mutexes](../../general/mutex.md) and [conditional variables](../../general/conditional_variables_(mutex).md). However these had a couple of downsides:
- Error prone usage.
- Lack of expressive power.
These also needed low level support via [atomic instructions](../../general/atomic_instruction.md).

[Atomic instruction](../../general/atomic_instruction.md)

There are different [synchronization](../../general/synchronization.md) constructs we will look at.

[Spinlocks](../../general/spinlocks.md)

[Semaphores](../../general/semaphores.md)

[Reader-writer locks](../../general/reader-writer_locks.md)

[Monitors](../../general/monitors.md)

However there are many more - though they all require support from the hardware to operate. Mainly through the use of [atomic instructions](../../general/atomic_instruction.md).
...
[Cache coherence](../../general/cache_coherence.md)
