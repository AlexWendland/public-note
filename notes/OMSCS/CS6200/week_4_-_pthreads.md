...
[Mutex](../../general/mutex.md) have 3 attributes:
- Mutex Type: can be changed to allow for [deadlock](../../general/deadlock.md) detection.
...
Some notes on [conditional variables](../../general/conditional_variables_(mutex).md):
...
- To avoid [spurious wakeups](../../general/spurious_wakeups.md) think about if you need to hold the [mutex](../../general/mutex.md) when doing your signal or broadcast.
