...
name: Week 16 - Datacenter technologies
tags:
  - OMSCS
type: lecture
week: 16
...
These different layers contact one another using [IPC](../../general/inter-process_communication_(ipc).md) methods such as [RPC](../../general/remote_procedure_calls_(prc).md) or shared memory (if they are located on the same machine).
...
- [Law of large numbers](../../general/law_of_large_numbers.md): With sufficiently many independent users the peaks in usage should average out to a fairly constant load.
