...
[Host (networks)](../../general/host_(networks).md)

[Client](../../general/client.md)
...
[Subnets](../../general/subnets.md)

[Network](../../general/network.md)

[Internet](../../general/internet.md)
...
[Gateway](../../general/gateway.md)

[Routers](../../general/router.md) make the hierarchy on the internet possible by owning the prefix for that [subnet](../../general/subnets.md).

Whilst these devices are called [routers](../../general/router.md) and [switches](../../general/switch.md) there is a more abstract concept here.

- [Switching](../../general/switching.md): The process of moving data within networks.
- [Routing](../../general/routing.md): The process of moving data between networks.
...
[Layer 1 Physical](../../general/layer_1_physical.md)

[Layer 2 Data Link](../../general/layer_2_data_link.md)

[MAC address](../../general/mac_address.md)

[Layer 3 Network](../../general/layer_3_network.md)

[Difference between an IP and MAC address](../../general/difference_between_an_ip_and_mac_address.md)

[layer 4](../../general/layer_4_transport.md)

[Layer 5 Session](../../general/layer_5_session.md)

[Layer 6 Presentation](../../general/layer_6_presentation.md)

[Layer 7 Application](../../general/layer_7_application.md)

The main other model of the internet is [IPS model](../../general/internet_protocol_stack_(ips)_5_layers.md)

[IPS model](../../general/internet_protocol_stack_(ips)_5_layers.md)
...
- [MAC address](../../general/mac_address.md),
- [Internet Protocol (IPv4)](../../general/internet_protocol_(ipv4).md), and
- [Network mask](../../general/network_mask.md) (this tells the [host](../../general/host_(networks).md) which other [hosts](../../general/host_(networks).md) are on its [network](../../general/network.md)).

Suppose we need host A to send data to host B.

As host A is already part of the [network](../../general/network.md) it has the [network mask](../../general/network_mask.md) already.

We will assume host A already has host B's [Internet Protocol (IPv4)](../../general/internet_protocol_(ipv4).md) through a [DN](dn.md) entry or an act of god.

The only further information about host B host A needs is its [MAC address](../../general/mac_address.md). To do this it will need to use the [Address Resolution Protocol (ARP)](../../general/address_resolution_protocol_(arp).md) as discussed before.

Every host has an [ARP cache](../../general/arp_cache.md) that stores the [MAC address](../../general/mac_address.md) against each [Internet Protocol (IPv4)](../../general/internet_protocol_(ipv4).md) it knows in the [network](../../general/network.md). If host B's address is already in host A's [ARP cache](../../general/arp_cache.md) it can use that to generate the layer 2 and 3 headers.

If not it will need to make an [ARP](../../general/address_resolution_protocol_(arp).md) request to the [network](../../general/network.md). It broadcasts its IP and MAC address on the network asking for the host at host B's IP address to respond. It does this by setting in the layer 2 header the all f's MAC address - an address reserved for the purpose of broadcasting to the local network.
...
[Node (IPv6)](../../general/node_(ipv6).md)

[Router (IPv6)](../../general/router_(ipv6).md)
...
the first entry would say any IP address matching the first 24 bits or the first 3 decimals of the IP address go here whereas the second entry says any address matching the first 16 bits or 2 decimals then go here. The second entry is called [route summarization](../../general/route_summarization.md). It is actually referring to a lot of [subnets](../../general/subnets.md) but groups them all index one entry as the first step is always to go to a single router. This can only be done if you arrange your IP addresses in a hierarchical manner.
...
Some were already described above. Such as [ARP](../../general/address_resolution_protocol_(arp).md) (RFC 826).

[FTP](../../general/file_transfer_protocol_(ftp).md)

[Simple Mail Transfer Protocol (SMTP)](../../general/simple_mail_transfer_protocol_(smtp).md)

[Hyper Text Transfer Protocol (HTTP)](../../general/hyper_text_transfer_protocol_(http).md)

[Secure Socket Layer (SSL)](../../general/secure_socket_layer_(ssl).md)

[Transport Layer Security (TLS)](../../general/transport_layer_security_(tls).md)
...
[Autonomous system (AS)](../../general/autonomous_system_(as).md)
...
[Client-Server model](../../general/client-server_model.md)

[Peer-peer model](../../general/peer-peer_model.md)
...
[Transmission Control Protocol (TCP)](../../general/transmission_control_protocol_(tcp).md)

[User Datagram Protocol (UDP)](../../general/user_datagram_protocol_(udp).md)
